        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                ...
                <a class="sidebar-brand brand-logo-mini" href="index.html"><img
                        src="admin_end/assets/images/logo-mini.svg" alt="logo" /></a>
            </div>
            <ul class="nav">
                    ...
                    <div class="profile-desc">
                        <div class="profile-pic">
                            <div class="count-indicator">
                                <img class="img-xs rounded-circle " src="admin_end/assets/images/faces/face15.jpg"
                                    alt="">
                ...
                <li class="nav-item menu-items">
                 ...
                 <li class="nav-item menu-items">
                    <a class="nav-link" data-toggle="collapse" href="#doctorMenu" aria-expanded="false"
